...
export const PAGE_AREAS: [prefix: string, areas: string[], min: 0 | 1][] = [
  ...
  ['/manager/reports/donations', ['Donations', 'Credits', 'Statistics'], 0],
  ['/manager/reports/marketplaces', ['Marketplaces', 'Statistics'], 0],
  ['/manager/reports/purchasers', ['Products'], 0],
  ['/manager/products/bulk', ['Products'], 1],
  ['/manager/products/export', ['Products'], 1],
