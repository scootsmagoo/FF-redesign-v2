...
CREATE INDEX `auth_account_provider_idx` ON `auth_account` (`provider_id`,`account_id`);--> statement-breakpoint
...
CREATE INDEX `auth_user_customer_idx` ON `auth_user` (`customer_id`);--> statement-breakpoint
